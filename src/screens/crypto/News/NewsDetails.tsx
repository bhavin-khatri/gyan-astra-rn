...
export class NewsDetails extends Component {
  ...
  getStockNews() {
    ...
    axios.get(url).then(response => {
      console.log('response getCryptoNews:::', response.data.news);
      this.setState({news_item: response.data.news}, () => {
            ...
            this.setState(
              {
                ...
                news_image: item.imgURL,
                news_title: item.title,
                news_date: item.feedDate,
            ...
            <View style={myStyles.BoxView}>
              ...
              <View style={myStyles.RowView}>
                ...
                <Text style={myStyles.DateText}>
                  {Utils.getDate(date, 'DD MMM YYYY', true)}
                </Text>
              </View>
            </View>
