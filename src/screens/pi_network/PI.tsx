...
import {DESCRIPTION, OTHER_ASTRAS, PI_SITE} from '../../utils/ApiConstants';
  ...
  constructor() {
    ...
    this.state = {
      Apps: [
        {
          title: 'Pi Networks',
          image: Images.ic_image_pinetwork,
        },
        {
          title: 'Pi Browser',
          image: Images.ic_image_pibrowser,
        },
        {
          title: 'Pi Converter',
          image: Images.ic_image_piconverter,
        },
      ],
    };
  }
    ...
    return (
      <View style={myStyles.ParentView}>
        <View style={myStyles.HeaderView}>
          ...
          <Text style={myStyles.Title}>{OTHER_ASTRAS.PI_ASTRA}</Text>
          <Image style={myStyles.TopImage} />
        </View>
        <View style={myStyles.TopLineView} />
        <ScrollView style={myStyles.BodyView}>
          <Text style={myStyles.BoldTxt16}>{DESCRIPTION.WHAT_IS_PI}</Text>
          <Text style={myStyles.SimpleTxt14}>{DESCRIPTION.PI_DESC}</Text>

          <Text style={myStyles.BoldTxt16}>{DESCRIPTION.KEY_LABEL}</Text>
          <Text style={myStyles.SimpleTxt14}>{DESCRIPTION.KEY_PI_1}</Text>
          <Text style={myStyles.SimpleTxt14}>{DESCRIPTION.KEY_PI_2}</Text>

          <Text style={myStyles.BoldTxt16}>PI Apps</Text>
          <FlatList
            numColumns={3}
          ...
          <TouchableOpacity
            ...
            onPress={() => Linking.openURL(PI_SITE)}>
            <Text
              style={{
